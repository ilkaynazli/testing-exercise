...
def is_mel(name, email):
    ...
    False
    >>> is_mel("Mel Melitpolski", 'random@random.com')
    True
    >>> is_mel("Random Random", 'mel@ubermelon.com')
    True
    >>> is_mel('mel melitpolski', 'mel@ubermelon.com')
    True
    >>> is_mel('Mel Melitpolski', 'MEL@UBERMELON.COM')
    True
    >>> is_mel('mel', 'random@random.com')
    True
    >>> is_mel('melitpolski', 'random@random.com')
    True
    
    """
    name_list = ['Mel Melitpolski', 'Mel', 'Melitpolski']
    return name.title() in name_list or email.lower() == "mel@ubermelon.com"
